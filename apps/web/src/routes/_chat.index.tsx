...
/**
 * The index route is the Harness graph surface. It falls back to the existing
 * onboarding hero until a project has been configured.
 */
function IndexDraftLanding() {
  ...
  if (projects.length > 0) return <HarnessWorkspace />;
