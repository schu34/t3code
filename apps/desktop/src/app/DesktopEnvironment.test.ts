...
describe("DesktopEnvironment", () => {
  it.effect("derives state paths and development identity inside Effect", () =>
    Effect.gen(function* () {
      ...
      assert.equal(environment.appUserModelId, "dev.harness.app.dev");
      assert.equal(environment.linuxWmClass, "harness-dev");
      assert.equal(environment.linuxDesktopEntryName, "dev.harness.app.Development.desktop");
      assert.deepEqual(
  ...
  it.effect("uses the stable desktop entry as the packaged Linux portal identity", () =>
    Effect.gen(function* () {
      ...
      assert.equal(environment.linuxDesktopEntryName, "dev.harness.app.desktop");
    }),
  );
  ...
  it.effect("keeps implicit development state separate from production state", () =>
    Effect.gen(function* () {
      ...
      assert.equal(development.stateDir, "/Users/alice/.harness/dev");
      assert.equal(production.stateDir, "/Users/alice/.harness/userdata");
    }),
  );
